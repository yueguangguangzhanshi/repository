...
verboseScatterplot(abs(geneModuleMembership[moduleGenes, column]),
                   ...
                   cex.main = 1.2, cex.lab = 1.2, cex.axis = 1.2, col = module,abline = TRUE)
text(abs(geneModuleMembership[moduleGenes, column]),
     abs(geneTraitSignificance[moduleGenes, 1]),modProbes,cex = 0.6,pos=3)
...
write.table(tT, file=stdout(), row.names=F, sep="\t") h